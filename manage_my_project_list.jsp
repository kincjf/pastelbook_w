                        ...
                        <div class="the-box no-border transparent no-margin">
                            ...
                            <div class="row edit-wrap">
                                <div class="col-xs-12 col-md-6">
                                    ...
                                    <button class="btn btn-default editInfo" type="submit" form="form<%=tmp.getId()%>" formaction="modify_project_data.jsp">정보수정</button>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <form id="form<%=tmp.getId()%>"><input type="hidden" name="id" value="<%=tmp.getId()%>" /></form>
                                    <button class="btn btn-default editContent" type="submit" form="form<%=tmp.getId()%>" formaction="tool_pc.jsp">내용수정</button>
                                </div>
                            </div>
