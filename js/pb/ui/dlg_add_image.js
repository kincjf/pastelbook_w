require(['jquery', 'underscore', 'jquery_ui', 'pb/collections/resources/ResImageList'],
	function ($, _, jquery_ui, ResImageList) {
		...
		var resImageList = new ResImageList();
		/** expected - error occured point : ResImageList url error */
		resImageList.fetch({
			reset: false,
			success: function(){
				resImageList.each(function(model){
					$('ul#sortable').append(
