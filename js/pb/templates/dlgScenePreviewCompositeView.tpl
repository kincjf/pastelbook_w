<div id="dlg_scene_preview" title="씬들">
    <p>Preview</p>
    <div class="ui-widget-footer" style="bottom:.1em; right: .1em;;position:absolute">
        a
    </div>
    <ul>
        <li id="add_slide" class="ui-state-highlight">새 씬</li>
    </ul>

    <ul id="slide-previews" class="sortable">
...
<!-- <script src="js/pb/ui/dlg-scene-preview.js"></script> -->